package com.linzhou.schentunion.view;

/*
 *项目名： Schentunion
 *包名：   com.linzhou.Schentunion.view
 *创建者:  linzhou
 *创建时间:17/05/01
 *描述:   
 */
...
public class AutoFillEmailEditText extends AutoCompleteTextView {
    ...
    private Emailboolean mEmailboolean;

    public void addEmailboolean(Emailboolean mEmailboolean) {
        this.mEmailboolean = mEmailboolean;
    }
